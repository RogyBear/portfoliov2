...
export default function Details(props) {
  ...
  let links = {
    birds: {
      demo: "https://www.2birdswedding.com",
      source: "https://github.com/RogyBear/2Birds",
    },
    jack: {
      demo: "https://www.blackjackcontracting.com",
      source: "https://github.com/RogyBear/Blackjack",
    },
    konin: {
      demo: "http://evgeniykonin.ru/",
      source: "https://github.com/RogyBear/Konin",
    },
  };
    ...
    <Fragment>
      ...
      <div className="details">
        <h2 className="details__title">
          {lang ? en[newPath].title : ru[newPath].title}
        </h2>
        ...
        <div className="details__section sectionOne">
          <div className="details__section__text">
            <p className="details__section__text__paragraph">
              {" "}
              {lang
                ? en[newPath].sectionOne.description
                : ru[newPath].sectionOne.description}
            </p>
          </div>
          <img
        ...
        <div className="details__section sectionTwo">
          ...
          >
            <h3 className="details__section__title">
              {lang
                ? en[newPath].sectionTwo.title
                : ru[newPath].sectionTwo.title}
            </h3>
        ...
        <div className="details__section sectionThree">
          ...
          >
            <h3 className="details__section__title">
              {lang
                ? en[newPath].sectionThree.title
                : ru[newPath].sectionThree.title}
            </h3>

            <ul className="details__section__text__list">
              <li className="details__section__text__list__item">
                {lang
                  ? en[newPath].sectionThree.featureOne
                  : ru[newPath].sectionThree.featureOne}
              </li>
              <li className="details__section__text__list__item">
                {lang
                  ? en[newPath].sectionThree.featureTwo
                  : ru[newPath].sectionThree.featureTwo}
              </li>
              <li className="details__section__text__list__item">
                {lang
                  ? en[newPath].sectionThree.featureThree
                  : ru[newPath].sectionThree.featureThree}
              </li>
              <li className="details__section__text__list__item">
                {lang
                  ? en[newPath].sectionThree.featureFour
                  : ru[newPath].sectionThree.featureFour}
              </li>
              <li className="details__section__text__list__item">
                {lang
                  ? en[newPath].sectionThree.featureFive
                  : ru[newPath].sectionThree.featureFive}
              </li>
            </ul>
          </div>

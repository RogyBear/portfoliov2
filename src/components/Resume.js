...
export default function Resume() {
  ...
  // All of the duties at FYD

  let fullstack = [
    "Developed Frontend side of several projects using advanced Javascript, Scss and HTML5.",
    "Developed backend for several e-commerce websites using wordpress and woocommerce.",
    "Utilized knowledge of PHP and Wordpress / ACF to develop backends of several websites.",
    "Worked with designers and other developers to create fully functional websites and apps.",
    "Created multiple apps including a music streaming app and an mortgage calculator using Flutter framework.",
    "Consumed various types of APIs inclduing one that registered COVID-19 results.",
    "Utilizied Twilio API to send mass text messages as well verifying user’s phone numbers.",
    "Created custom administration panel for medical website.",
  ];
      ...
      <div className="resume__wrapper">
        ...
        <div className="resume__wrapper__col">
          <div className="resume__wrapper__col__left">
            <div className="resume__wrapper__col__left__title">
              Professional Experience
            </div>
            <div className="resume__wrapper__col__left__job">
              Fullstack Developer
            </div>
            <div className="resume__wrapper__col__left__dates">
              For You Design | Chicago, Illinois | 05 / 2019 - 09 / 2019
            </div>
            <div className="resume__wrapper__col__left__duties">
              {fullstack.map((e) => {
                return (
                  <li className="resume__wrapper__col__left__duties__items">
                    {e}
                  </li>
                );
              })}
            ...
            <div className="resume__wrapper__col__left__project">
              Project: 2 Birds Wedding Co
            </div>
            <div className="resume__wrapper__col__left__duties">
            ...
            <div className="resume__wrapper__col__left__dates">
              Portland State University | Portland, Oregon | 02 / 2012 - 08 /
              2015
            </div>
            <div className="resume__wrapper__col__left__duties">
              {arrAVT.map((e) => {
            ...
            <div className="resume__wrapper__col__left__dates">
              Portland State University | Portland, Oregon | 09 / 2011 - 08 /
              2015
            </div>
          </div>
          <div className="resume__wrapper__col__right">
            <div className="resume__wrapper__col__right__title">
              Technologies
            </div>
            <div className="resume__wrapper__col__right__tech">
              {tech.map((e) => {
                return (
                  <li className="resume__wrapper__col__right__tech__item">
                    {e}
                  </li>
                );
              })}

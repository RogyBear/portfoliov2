  ...
  return (
    <nav className="nav">
      <div className="nav__arrow">
        <div
          className="nav__arrow__translation"
          style={lang ? {} : { right: "150px" }}
        >
          <svg
          ...
          <p className="nav__arrow__translation__text">
            {lang ? en.click : ru.click}
          </p>
        </div>
      </div>
      ...
      <ul className="nav__list">
        ...
        <li className="nav__list__item language-change" onClick={handleLang}>
          <button className="nav__list__item__link btn btn-en">
            {!lang ? "EN /" : "РУ /"}
          </button>
          <button className="nav__list__item__link btn btn-ru">
            {lang ? "EN " : "РУ"}
          </button>
        </li>
        <li className="nav__list__item">
